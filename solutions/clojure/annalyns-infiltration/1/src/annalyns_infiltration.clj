...
(defn can-spy?
  ...
  (or prisoner-awake? knight-awake? archer-awake?)
  )
...
(defn can-free-prisoner?
  ...
  [knight-awake? archer-awake? prisoner-awake? dog-present?]
    (or 
     (and dog-present? knight-awake? (not archer-awake?)) 
     (and prisoner-awake? (and (not archer-awake?) (not knight-awake?) (not dog-present?)))
     (and dog-present? (and (not archer-awake?) (not knight-awake?)))
    )
)
